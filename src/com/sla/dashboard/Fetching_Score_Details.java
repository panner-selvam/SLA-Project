	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
				...
				try { 
					...
					if (con != null) {
						String query = "select status, SUM(cast (isnull(points,'0') as Float)) as cnt from dbo.Bind_SLA_Module_Points where CAST(CONVERT(char(10),dateofresponse,126) AS DATE) = convert(char(10),dateadd(day,datediff(day,1,GETDATE()),0),126) and isactive=1 group by status";
