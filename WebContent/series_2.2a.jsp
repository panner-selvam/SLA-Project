    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 2.2 a</b></h4>
        </div>
        <div class="modal-body" id="modal-id" oninput="get_input()" onchange="get_input()">
        	...
        	<div class="row">
        		<div class="col-sm-6 ">
        			...
        			<input type="text" class="form-control" id="applicationName" value="SMC" disabled>
        		</div>
        		<div class="col-sm-6">
...
<script>
	...
	var series_no = "tbl_2_2_a_to_2_9", mode="tbl_2_2_a",ip_address="", location_name="", application_name="", time="",series_date="";
