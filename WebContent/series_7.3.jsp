	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 7.3<div class="btn-group pull-right" style="    margin-top: 3px;">
				...
				<div class="row">
					...
					<div class="col-sm-6 ">
						<label><b>Compliance (%)</b></label> <input type="text"
							class="form-control number_and_dot" id="Compliance" Onfocusout="get_id_value(this.id)">
					</div>
				</div>
			</div>
...
function series_table(obj) {
	...
	var series_no = "tbl_7_3", series_date = "",name="",place="",compliance = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
