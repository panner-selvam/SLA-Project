	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 6.2<div class="btn-group pull-right" style="    margin-top: 3px;">
		...
		<table id="example"
			...
			<tr id="msgcnt">
				...
				<tr><th class="text-center" style="width:5%">Sl.No</th>
					...
					<th class="col-md-1 text-center">Datacenter</th>
