			...
			<table id="example" class="table table-striped table-bordered table table-hover"  style="width:100%; display:block">
				<thead>
					<tr>
						...
						<th class="col-md-9 text-center">PERFORMANCE AREA</th>
						<th class="col-md-1 text-center">POINTS</th>
						<th class="col-md-1 text-center">STATUS</th>
						<th ></th>
					</tr>
				</thead>
				<tbody id="series_table" style='height:280px; display:block; overflow:scroll; width:100%'></tbody>
			</table>
			<script type="text/javascript">
				function seriesTableFeed(obj){
					...
					if(obj==""){
							k+='<tr>';
							k+='<td class="text-center" style="padding-top: 107px; width: 765px; height: 260px;background-color: lightgray"><h2>DATA NOT AVAILABLE</h2></td>';
							k+='</tr>';
				...
				var s=0;
					...
					s++;
						k+='<tr>';
						k+='<td class="col-md-1 text-center">'+s+'</td>';
						k+='<td class="col-md-9 text-left">'+obj[i].SERISE+'</td>';
						k+='<td class="col-md-1 text-center">'+obj[i].POINTS+'</td>';
						if((obj[i].STATUS)==("Baseline")){
							k+='<td class="col-md-1 text-center"><span class="label label-success">'+obj[i].STATUS+'</span></td>';
						}
						else if((obj[i].STATUS)==("Breach")){
							k+='<td class="col-md-1 text-center"><span class="label label-danger">'+obj[i].STATUS+'</span></td>';
						}
						k+='</tr>';
					}
					k+='</tbody>';
		...
		<!-- Sticky note --> 
			...
			<div class="panel panel-default col-md-4 ">
				<div class="panel-heading">
					...
					<i id="reminder" style="padding-left:90px;display:none">Click to stick ></i>
