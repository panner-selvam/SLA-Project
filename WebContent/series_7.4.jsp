	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 7.4<div class="btn-group pull-right" style="    margin-top: 3px;">
...
function series_table(obj) {
	...
	var series_no = "tbl_7_4", series_date = "",release_date="",patch_name="",patch_oem="",app_start_date="",app_close_date,compliance="",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
