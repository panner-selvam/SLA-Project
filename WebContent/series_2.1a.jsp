...
<div class="main_content">
	...
	<div class="row" id="series_list">
			<table id="report" class="table table-striped table-bordered table table-hover"  style="width:100%">
				<thead>
				<tr id="msgcnt">
				...
				<tr><th class="text-center" style="width:5%">Sl.No</th>
						...
						<th class="col-md-1 text-center">Host Name</th>
						<th class="col-md-1 text-center">IP Address</th>
						<th class="col-md-1 text-center">Data center</th>
						<th class="col-md-2 text-center">Application Name</th>
						<th class="col-md-2 text-center">Display Name</th>
						<th class="col-md-1 text-center">Process Name</th>
    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 2.1 a</b></h4>
        </div>
        <div class="modal-body" id="modal-id" oninput="get_input()" onchange="get_input()">
        	<div class="row">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success not_null" id="save" disabled>SAVE</button>
        </div>
      </div>
...
<script>
	...
	function series_table(obj) {
		...
		if (obj == "") {
			...
			$.each(obj, function(key, data) {
				...
				k += '<td class="col-md-1 text-center">' + data.hostName
						+ '</td>';
				k += '<td class="col-md-1 text-center">' + data.ipAddress
						+ '</td>';
				k += '<td class="col-md-1 text-center">' + data.dataCenter
						+ '</td>';
				k += '<td class="col-md-2 text-center">' + data.applicationName
						+ '</td>';
				k += '<td class="col-md-2 text-center">' + data.displayName
						+ '</td>';
				k += '<td class="col-md-1 text-center">' + data.prcessName
						+ '</td>';
				k += '<td class="col-md-1 text-center">'
						+ data.prcessAvailability + '</td>';
				k += '<td class="col-md-1 text-center">'
						+ data.overallAvailability + '</td>';
	...
	var series_no = "tbl_2_1_a", hostName, ipAddress, dataCenter, applicationName, displayName, processName, processAvailability, overallAvailability, series_date;
	...
	function get_input() {
		...
		if (hostName != '' && ipAddress != '' && dataCenter != ''
				&& applicationName != '' && displayName != ''
				&& processName != '' && processAvailability != ''
				&& overallAvailability != '') {
