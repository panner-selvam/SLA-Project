	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 5.4<div class="btn-group pull-right" style="    margin-top: 3px;">
...
function series_table(obj) {
	...
	var series_no = "tbl_5_4", series_date = "",ip_address="",hostname="",region="",zone="",location_name="", up_time = "",down_time = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
