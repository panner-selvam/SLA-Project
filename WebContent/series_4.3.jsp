			...
			<table id="example" class="table table-striped table-bordered table table-hover"  style="width:100%">
				...
				<tr id="msgcnt">
					...
					<tr><th class="text-center" style="width:5%">S.No</th>
						...
						<th class="col-md-2 text-center">Road Worthiness</th>
    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 4.3</b></h4>
        </div>
					...
					<div class="col-sm-6 ">
						<label><b>Vehicle No</b></label>
						  ...
						  <select class="form-control" id="vehicleNo">
					        <option>MH-01-DB-0566</option>
					        <option>MH-01-DB-0568</option>
					        <option>MH-01-DB-0569</option>
					        <option>MH-01-DB-0577</option>
					        <option>MH-06-AA-0534</option>
					      </select>
						
					
					</div>
					<div class="col-sm-6 ">
    				<label><b>Road Worthiness</b></label>
    				<input type="text" class="form-control" id="roadWorthiness" value="100" disabled>   		
        		</div>
        	</div>
        	<div class="row">
        		<div class="col-sm-6 ">
        		...
        		<div class="col-sm-6 ">
        			...
        			<input type="text" class="form-control number_and_dot" id="Failure" value="0" disabled>
        		</div>
        	</div>
        </div>
		...
		function series_table(obj){
			...
			if(obj==""){
				...
				$.each(obj,function (key, data){
					...
					k+='<td class="col-md-1 text-center">'+data.vehicle_no+'</td>';
					k+='<td class="col-md-1 text-center">'+data.road_worthiness+'</td>';
		...
		var table_name="tbl_4_3",vehicle_no="",road_worthiness="",success="",failure="",series_date="";
		...
		function get_input(){
			...
			road_worthiness = $('#roadWorthiness').val();
			failure = $('#Failure').val();
			series_date = $('#seriesDate').val(); 
			success = $('#Success').val();
			
			if(vehicle_no!=''&&road_worthiness!=''&&success!=''&&failure!=''){
