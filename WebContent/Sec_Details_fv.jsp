		...
		<div style="overflow: hidden; position: relative; width: 1065px;">
			<div>
				<ul style="width: 5006px;">
					...
					<li>Report</a></li>
					<!-- 	<li><a href="#">2.3</a></li> -->
					<li><a href="<%=request.getContextPath()%>/Series.jsp"><b>Common
								Reporting</b></a></li>
				...
				<div class="w-box" id="w_sort01">
					...
					<div class="w-box-content cnt_a">
						<div class="sepH_b col-sm-3" style="display: none;">
							...
							<label for="mode">Series </label> <select name="series_list"
								id="series_list" class="form-control"
								onchange="getsubseriesinfo();">
						...
						<div class="sepH_b col-sm-3" style="display: none;">
							...
							<label for="mode">Sub Series </label> <select
								name="sub_series_list" id="sub_series_list" class="form-control">
						...
						<div class="clearfix">
							<div class="col-sm-6  mt-1">
								<button class="btn btn-warning mr-1  " value="refresh"
									id="refresh" onClick="getrefresh();">Refresh</button>
								<button class="btn btn-primary mr-1 " value="Search" id="search"
									onClick="getsearch('1');">Search</button>
								<button class="btn btn-info mr-1" value="Export to Excel"
									id="exporttoexcel" onclick="getexlview_ins()"
									style="display: none;">Export to Excel</button>
							</div>
						</div>
					</div>
				</div>
...
var dp_end=$("#dp_end").val();
		...
		var excel = path+'/ExporttoExcel_5.jsp?uid=<%=session_vid_resouce%>&fdate='+dp_start+'&tdate='+dp_end+'&sub_series_list='+sub_series_list+'&sname='+sname;
...
$.ajax({
			type : "post",
			url : path + "/Fetching_fv_Series_report_lazyload",
			async : false,
			...
			success : function(h) {
				...
				if(sub_series_list=="<%=series_name_5_5%>"){
					...
					cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">IP address</th><th class="text-center">Location</th><th class="text-center">Uptime (%)</th><th class="text-center">DownTime (%)</th> </tr></thead><tbody>';
					
				}
				
				else	if(sub_series_list=="<%=series_name_5_4%>"){
					...
					cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">IP address</th><th class="text-center">Hostname</th><th class="text-center">Region</th><th class="text-center">Zone</th><th class="text-center">Police Station</th><th class="text-center">Uptime (%)</th><th class="text-center">DownTime  (%)</th> </tr></thead><tbody>';
					
				}
				
				else if(sub_series_list=="<%=series_name_5_3%>"){
					...
					cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Video wall IP</th><th class="text-center">Equipment type</th><th class="text-center">Location</th><th class="text-center">Uptime (%)</th><th class="text-center">DownTime (%)</th> </tr></thead><tbody>';
					 */
					 cond='<table class="table table-striped table-bordered table-condensed display nowrap"	id="reportdata" width="100%"><thead><tr id="msgcnt"><th colspan="9" ><div id="rowpintdiv" style="font-weight:bold;"><div class="recordscnt">Total Records - <span id="passport_row_totcnt"></span>/<span id="passport_row_cnt"></span></div></th></tr>';
						cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">IP address</th><th class="text-center">Hostname</th><th class="text-center">Region</th><th class="text-center">Zone</th><th class="text-center">Police Station</th><th class="text-center">Uptime (%)</th><th class="text-center">DownTime  (%)</th> </tr></thead><tbody>';
						 	
				}
				else	if(sub_series_list=="<%=series_name_5_2%>"){
					 cond='<table class="table table-striped table-bordered table-condensed display nowrap"	id="reportdata" width="100%"><thead><tr id="msgcnt"><th colspan="7" ><div id="rowpintdiv" style="font-weight:bold;"><div class="recordscnt">Total Records - <span id="passport_row_totcnt"></span>/<span id="passport_row_cnt"></span></div></th></tr>';
					cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Video wall IP</th><th class="text-center">Equipment type</th><th class="text-center">Location</th><th class="text-center">Uptime (%)</th><th class="text-center">DownTime (%)</th> </tr></thead><tbody>';
					
				}
				else	if(sub_series_list=="<%=series_name_5_1%>"){
					 cond='<table class="table table-striped table-bordered table-condensed display nowrap"	id="reportdata" width="100%"><thead><tr id="msgcnt"><th colspan="7" ><div id="rowpintdiv" style="font-weight:bold;"><div class="recordscnt">Total Records - <span id="passport_row_totcnt"></span>/<span id="passport_row_cnt"></span></div></th></tr>';
					cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">IP address</th><th class="text-center">Hostname</th><th class="text-center">Location</th><th class="text-center">Uptime</th><th class="text-center">DownTime</th> </tr></thead><tbody>';
				...
				$.each(j,function(a, b) {
					i++;
if(sub_series_list=="<%=series_name_5_5%>"){
cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td>"+b.IP+"</td><td style='text-align:Center;'>"+b.Location+"</td><td style='text-align:Center;'>"+b.UPTime+"</td><td style='text-align:Center;'>"+b.DownTime+"</td></tr>";
			
					}
else	if(sub_series_list=="<%=series_name_5_4%>"){
cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td >"+b.Ipaddress+"</td><td style='text-align:Center;'>"+b.Region+"</td><td style='text-align:Center;'>"+b.Zone+"</td><td style='text-align:Center;'>"+b.Policestation+"</td><td style='text-align:Center;'>"+b.UPTime+"</td><td style='text-align:Center;'>"+b.DownTime+"</td></tr>";
}
				
else	if(sub_series_list=="<%=series_name_5_3%>"){
//cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</td><td>"+b.Video_wall_ip+"</td><td style='text-align:Center;'>"+b.Equipment_type+"</td><td style='text-align:Center;'>"+b.Location+"</td><td style='text-align:Center;'>"+b.UPTime+"</td><td style='text-align:Center;'>"+b.DownTime+"</td></tr>";
	cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td >"+b.Ipaddress+"</td><td style='text-align:Center;'>"+b.Region+"</td><td style='text-align:Center;'>"+b.Zone+"</td><td style='text-align:Center;'>"+b.Policestation+"</td><td style='text-align:Center;'>"+b.UPTime+"</td><td style='text-align:Center;'>"+b.DownTime+"</td></tr>";
}
	...
	cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</td><td>"+b.IPaddress+"</td><td style='text-align:Center;'>"+b.Hostname+"</td><td style='text-align:Center;'>"+b.Location+"</td><td style='text-align:Center;'>"+b.UPTime+"</td><td style='text-align:Center;'>"+b.DownTime+"</td></tr>";
}
				...
				upavg=parseInt(upavg)+parseInt(b.UPTime);
				downavg=parseInt(downavg)+parseInt(b.DownTime);
				
				uptotavg= b.Total_uptime;
				downtotavg= b.Total_downtime;
				
				
				});			
				if(sub_series_list=="<%=series_name_5_5%>"){
				
				cond=cond+" <tfoot>            <tr>                <th colspan='4' style='text-align:right'>Average:</th>                 <th id='upavg' style='text-align:center;font-weight:bold;'></th>  <th id='downavg' style='text-align:center;font-weight:bold;'></th>            </tr>        </tfoot>";
				}
				else	if(sub_series_list=="<%=series_name_5_4%>"){
					cond=cond+" <tfoot>            <tr>                <th colspan='6' style='text-align:right'>Average:</th>                 <th id='upavg' style='text-align:center;font-weight:bold;'></th>  <th id='downavg' style='text-align:center;font-weight:bold;'></th>            </tr>        </tfoot>";
				}
				else	if(sub_series_list=="<%=series_name_5_3%>"){
					//cond=cond+" <tfoot>            <tr>                <th colspan='5' style='text-align:right'>Average:</th>                 <th id='upavg' style='text-align:center;font-weight:bold;'></th>  <th id='downavg' style='text-align:center;font-weight:bold;'></th>            </tr>        </tfoot>";
					cond=cond+" <tfoot>            <tr>                <th colspan='6' style='text-align:right'>Average:</th>                 <th id='upavg' style='text-align:center;font-weight:bold;'></th>  <th id='downavg' style='text-align:center;font-weight:bold;'></th>            </tr>        </tfoot>";
				}
				else	if(sub_series_list=="<%=series_name_5_2%>"){
					cond=cond+" <tfoot>            <tr>                <th colspan='5' style='text-align:right'>Average:</th>                 <th id='upavg' style='text-align:center;font-weight:bold;'></th>  <th id='downavg' style='text-align:center;font-weight:bold;'></th>            </tr>        </tfoot>";
				...
				upavg=parseInt(upavg)/parseInt(i);
				upavg=parseFloat(upavg.toFixed(2));
				
				downavg=parseInt(downavg)/parseInt(i);
				downavg=parseFloat(downavg.toFixed(2));
			...
			$("#exporttoexcel").css("display","none");
					...
					$("#upavg").html(upavg+"(Total Average - " +uptotavg+")");
					$("#downavg").html(downavg+"(Total Average - " +downtotavg+")");
