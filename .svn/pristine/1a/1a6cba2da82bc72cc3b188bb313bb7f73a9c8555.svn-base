			...
			<table id="example" class="table table-striped table-bordered table table-hover"  style="width:100%">
				...
				<tr id="msgcnt">
					...
					<tr><th class="text-center" style="width:5%">S.No</th>
						...
						<th class="col-md-2 text-center">Times (Secs)</th>
    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 2.5 (a) </b></h4>
        </div>
        <div class="modal-body" id="modal-id" oninput="get_input()">
        	...
        	<div class="row">
        		<div class="col-sm-6 ">
    				...
    				<input type="text" class="form-control" id="Location" value="Command_Center" disabled>   		
        		</div>
        		<div class="col-sm-6 ">
...
<script>
	...
	var series_no = "tbl_2_2_a_to_2_9", mode="tbl_2_5_a",ip_address="", location_name="", application_name="", time="",series_date="";
