	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 6.5<div class="btn-group pull-right" style="    margin-top: 3px;">
...
function series_table(obj) {
	...
	var series_no = "tbl_6_5", series_date = "",ip_address="",hostname="",Location_name="",uptime = "",downtime="",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
