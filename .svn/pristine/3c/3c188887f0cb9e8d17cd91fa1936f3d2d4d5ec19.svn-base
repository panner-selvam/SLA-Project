	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 5.5<div class="btn-group pull-right" style="    margin-top: 3px;">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal-id" oninput="get_input()">
				...
				<div class="row">
					<div class="col-sm-6">
						<label><b>IP</b></label> <input type="text"
				...
				<div class="row">
					<div class="col-sm-6 ">
						<label><b>Uptime</b></label> <input type="text"
							class="form-control numberonly" id="Uptime">
					</div>
					<div class="col-sm-6 ">
						<label><b>Downtime</b></label> <input type="text"
							class="form-control numberonly" id="Downtime">
					</div>
				</div>
...
function series_table(obj){
	...
	var series_no = "tbl_5_5", series_date = "",ip="",location_name="", uptime = "",downtime = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
