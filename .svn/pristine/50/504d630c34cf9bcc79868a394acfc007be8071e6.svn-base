		...
		<div style="overflow: hidden; position: relative; width: 1065px;">
			<div>
				<ul style="width: 5006px;">
					...
					<!-- 	<li><a href="#">2.3</a></li> -->
					<li class="last"><b>SLA - Overall Report</b></li>
				</ul>
			</div>
		</div>
	</div>
	<section class="content_b">
		<div class="row">
			<div class="col-md-2">
				...
				<div class="input-group" data-date-format="mm/dd/yy">
			...
			<div class="col-md-2">
				...
				<div class="col-md-2">
					<label>Points <span class="f_req">*</span></label>
					<select name="points" id="points" class="form-control">
					
					</select>
					</div>
			<div class="col-md-3">
					<label>Performance Area <span class="f_req">*</span></label>
					<select name="parea" id="parea" class="form-control"></select>
