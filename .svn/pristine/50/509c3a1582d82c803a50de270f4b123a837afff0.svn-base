	...
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 6.3<div class="btn-group pull-right" style="    margin-top: 3px;">
		...
		<table id="example"
			...
			<tr id="msgcnt">
				...
				<tr><th class="text-center" style="width:5%">Sl.No</th>
					...
					<th class="col-md-2 text-center">Place</th>
					<th class="col-md-1 text-center">Online</th>
					<th class="col-md-2 text-center">Offline</th>
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal-id" oninput="get_input()">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<label><b>Online</b></label> <input type="text"
							class="form-control numberonly" id="Online">
					</div>
					
				</div>
				<div class="row">
					<div class="col-sm-6 ">
						<label><b>Offline</b></label> <input type="text"
							class="form-control numberonly" id="Offline">
					</div>
					<div class="col-sm-6 ">
...
function series_table(obj) {
	...
	var series_no = "tbl_6_3", series_date = "",name="",place="",online="",offline = "",uptime = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
