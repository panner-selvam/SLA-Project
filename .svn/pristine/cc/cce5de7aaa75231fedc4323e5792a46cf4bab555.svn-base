		...
		<div style="overflow: hidden; position: relative; width: 1065px;">
			<div>
				<ul style="width: 5006px;">
					...
					<!-- 	<li><a href="#">2.3</a></li> -->
					<li><b><%=series_name_1_9 +" ~ "+series_main_module_name_1 %></b></li>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="w-box" id="w_sort01">
					<div class="w-box-header">Series 1.9<div class="btn-group pull-right" style="    margin-top: 3px;">
...
<%-- 			  	var number = getUrlVars()["req"];	
		...
		var series_no="<%=series_name_1_9%>",series_name="<%=series_main_module_name_1%>";
