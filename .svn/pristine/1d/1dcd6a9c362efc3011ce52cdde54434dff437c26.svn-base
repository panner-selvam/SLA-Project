		...
		<div style="overflow: hidden; position: relative; width: 1065px;">
			<div>
				<ul style="width: 5006px;">
					...
					<!-- 	<li><a href="#">2.3</a></li> -->
					<li class="last"><b>Underlying IT Infrastructure Uptime/Availability at Data Centres</b></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="w-box" id="w_sort01">
				<div class="w-box-header">Series 6.1<div class="btn-group pull-right" style="    margin-top: 3px;">
		...
		<table id="example"
			...
			<tr id="msgcnt">
				...
				<tr><th class="text-center" style="width:5%">Sl.No</th>
					...
					<th class="col-md-2 text-center">Uptime (%)</th>
					<th class="col-md-1 text-center">Downtime (%)</th>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal-id" oninput="get_input()">
				...
				<div class="row">
					<div class="col-sm-6 ">
						<label><b>Application Name</b></label> <input type="text"
							class="form-control" id="applicationName">
					</div>
					<div class="col-sm-6">
						<label><b>Data Center</b></label> <input type="text"
							class="form-control" id="dataCenter">
					</div>
				...
				<div class="row">
					<div class="col-sm-6 ">
						<label><b>Uptime (%)</b></label> <input type="text"
							class="form-control number_and_dot" id="upTime" Onfocusout="get_id_value(this.id)">
					</div>
					<div class="col-sm-6 ">
						<label><b>Downtime (%)</b></label> <input type="text"
							class="form-control number_and_dot" id="downTime" Onfocusout="get_id_value(this.id)">
					</div>
				</div>
			</div>
...
function series_table(obj) {
	...
	var series_no = "tbl_6_1", series_date = "",ip_address="",name="",data_center="",application_name="",up_time = "",down_time = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
