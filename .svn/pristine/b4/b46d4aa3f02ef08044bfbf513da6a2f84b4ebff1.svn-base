		...
		<table id="example"
			...
			<tr id="msgcnt">
				...
				<tr><th class="text-center" style="width:5%">Sl.No</th>
					...
					<th class="col-md-1 text-center">Zone</th>
					<th class="col-md-1 text-center">Police Station</th>
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal-id" oninput="get_input()">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<label><b>Region</b></label> <input type="text"
							class="form-control" id="Region">
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 ">
						<label><b>Zone</b></label> <input type="text"
							class="form-control" id="Zone">
					</div>
					<div class="col-sm-6 ">
						<label><b>Police Station</b></label> <input type="text"
							class="form-control" id="policeStation">
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 ">
...
function series_table(obj) {
	...
	var series_no = "tbl_5_3", series_date = "",ip_address="",hostname="",region="",zone="",police_station="", up_time = "",down_time = "",from_date = "", to_date = "";
	$("#clr").click(function() {
		clear();
	});
	function get_input(){
