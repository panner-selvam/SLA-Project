...
var dp_end=$("#dp_end").val();
		...
		var excel = path+'/ExporttoExcel_6.jsp?uid=<%=session_vid_resouce%>&fdate='+dp_start+'&tdate='+dp_end+'&sub_series_list='+sub_series_list+'&sname='+sname;
...
$.ajax({
			type : "post",
			url : path + "/Fetching_sx_Series_report_lazyload",
			async : false,
			...
			success : function(h) {
				...
				if(sub_series_list=="<%=series_name_6_4%>"){
				 ...
				 cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Security Name</th><th class="text-center">Attendance</th><th class="text-center">Location</th> </tr></thead><tbody>';
				 }
				
				 
				if(sub_series_list=="<%=series_name_6_1%>"){
				 ...
				 cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Ipaddress</th><th class="text-center">Name</th><th class="text-center">Data center</th><th>Application name</th><th>Uptime (%)</th><th>Downtime (%)</th> </tr></thead><tbody>';
				 }
				 
				if(sub_series_list=="<%=series_name_6_2%>"){
					 ...
					 cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Ipaddress</th><th class="text-center">Host Name</th><th class="text-center">Data center</th><th>Uptime(%)</th><th>Downtime(%)</th> </tr></thead><tbody>';
				 }
				 
				if(sub_series_list=="<%=series_name_6_3%>"){
					 cond='<table class="table table-striped table-bordered table-condensed display nowrap"	id="reportdata" width="100%"><thead><tr id="msgcnt"><th colspan="8" ><div id="rowpintdiv" style="font-weight:bold;"><div class="recordscnt">Total Records - <span id="passport_row_totcnt"></span>/<span id="passport_row_cnt"></span></div></th></tr>';
					 cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Name</th><th class="text-center">Place</th><th class="text-center">Data time</th><th>Online</th><th>Offline</th> <th>Uptime(%)</th> </tr></thead><tbody>';
				 }
				 
				if(sub_series_list=="<%=series_name_6_5%>"){
					 cond='<table class="table table-striped table-bordered table-condensed display nowrap"	id="reportdata" width="100%"><thead><tr id="msgcnt"><th colspan="7" ><div id="rowpintdiv" style="font-weight:bold;"><div class="recordscnt">Total Records - <span id="passport_row_totcnt"></span>/<span id="passport_row_cnt"></span></div></th></tr>';
					 cond=cond+'<tr><th class="text-center">Sl.No</th><th class="text-center">Date</th><th class="text-center">Ipaddress</th><th class="text-center">Host name</th><th class="text-center">Location</th><th>Uptime(%)</th><th>Downtime(%)</th> </tr></thead><tbody>';
				 }
				...
				$.each(j,function(a, b) {
					i++;
					if(sub_series_list=="<%=series_name_6_4%>"){
				cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td style='text-align:Center;'>"+b.SecurityName+"</td><td style='text-align:Center;'>"+b.Attendance+"</td><td style='text-align:Center;'>"+b.Location+"</td></tr>";
					}
			
					else if(sub_series_list=="<%=series_name_6_1%>"){
						cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td style='text-align:Center;'>"+b.Ipaddress+"</td><td style='text-align:Center;'>"+b.name+"</td><td style='text-align:Center;'>"+b.datacenter+"</td><td style='text-align:Center;'>"+b.applicationname+"</td><td style='text-align:Center;'>"+b.Uptime+"</td><td style='text-align:Center;'>"+b.Downtime+"</td></tr>";
		...
		downtotavg= b.Totdowntime;
					...
					else if(sub_series_list=="<%=series_name_6_2%>"){
						cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td style='text-align:Center;'>"+b.Ipaddress+"</td><td style='text-align:Center;'>"+b.hostname+"</td><td style='text-align:Center;'>"+b.datacenter+"</td><td style='text-align:Center;'>"+b.Uptime+"</td><td style='text-align:Center;'>"+b.Downtime+"</td></tr>";
uptimeavg=parseInt(uptimeavg)+parseInt(b.uptime);
		...
		downtotavg= b.Totdowntime;
					...
					else if(sub_series_list=="<%=series_name_6_3%>"){
						cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td style='text-align:Center;'>"+b.name+"</td><td style='text-align:Center;'>"+b.place+"</td><td style='text-align:Center;'>"+b.online+"</td><td style='text-align:Center;'>"+b.offline+"</td><td style='text-align:Center;'>"+b.Uptime+"</td></tr>";
uptimeavg=parseInt(uptimeavg)+parseInt(b.uptime);
					...
					else if(sub_series_list=="<%=series_name_6_5%>"){
						cond=cond+"<tr><td style='text-align:center;'>"+b.rownumber+"</td><td>"+b.date+"</a></td><td style='text-align:Center;'>"+b.Ipaddress+"</td><td style='text-align:Center;'>"+b.hostname+"</td><td style='text-align:Center;'>"+b.location+"</td><td style='text-align:Center;'>"+b.Uptime+"</td><td style='text-align:Center;'>"+b.Downtime+"</td></tr>";
uptimeavg=parseInt(uptimeavg)+parseInt(b.uptime);
		...
		downtotavg= b.Totdowntime;
				...
				if(sub_series_list=="<%=series_name_6_1%>"){
					cond=cond+" <tfoot>            <tr>                <th colspan='6' style='text-align:right'>Average:</th>                <th id='uptimeavg' style='text-align:right;font-weight:bold;'></th>      <th id='downtotavg' style='text-align:right;font-weight:bold;'></th>       </tr>        </tfoot>";
					...
					cond=cond+" <tfoot>            <tr>                <th colspan='8' style='text-align:right'>Average:</th>                <th id='uptimeavg' style='text-align:right;font-weight:bold;'></th>            </tr>        </tfoot>";
			...
			$("#exporttoexcel").css("display","none");
					...
					cond=cond+"<tr><td colspan='12'>No data available</td></tr>";
					$("#report").html(cond+"</tbody> </table>");	
