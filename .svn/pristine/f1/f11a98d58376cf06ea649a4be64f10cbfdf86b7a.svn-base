    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 2.7 (a) </b></h4>
        </div>
...
<script>
	...
	var series_no = "tbl_2_2_a_to_2_9", mode="tbl_2_7_a",ip_address="", location_name="", application_name="", time="",series_date="";
