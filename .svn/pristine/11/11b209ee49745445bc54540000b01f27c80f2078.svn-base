...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 2.9</b></h4>
        </div>
        <div class="modal-body" id="modal-id" oninput="get_input()">
        	...
        	<div class="row">
        		...
        		<div class="col-sm-6 ">
        			...
        			<input type="text" class="form-control" id="applicationName" value="RHMS" disabled>
        		</div>
        	</div>
        	<div class="row">
        		<div class="col-sm-6 ">
	...
	var series_no = "tbl_2_2_a_to_2_9", mode="tbl_2_9",ip_address="", location_name="", application_name="", time="",series_date="";
