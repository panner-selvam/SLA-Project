	...
	<div class="row">
		<div class="col-md-12">
				<div class="w-box" id="w_sort01">
					<div class="w-box-header">Series 6.4<div class="btn-group pull-right" style="    margin-top: 3px;">
	...
	<div class="row" id="series_list">
			...
			<tr id="msgcnt">
					...
					<tr><th class="text-center" style="width:5%">Sl.No</th>
						...
						<th class="col-md-3 text-center">Security Name</th>
						<th class="col-md-2 text-center">Attendance</th>
						<th class="col-md-3 text-center">Location</th>
    ...
    <div class="modal-dialog modal-lg"> 
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"> <b>Series 6.4 </b></h4>
        </div>
        <div class="modal-body" id="modal-id" oninput="get_input()">
        	<div class="row">
        		<div class="col-sm-6 ">
        			<label><b>Security Name</b></label>
        			<input type="text" class="form-control" id="securityName">
        		</div>
		...
		function series_table(obj){
			...
			if(obj==""){
				...
				$.each(obj,function (key, data){
					...
					k+='<td class="col-md-1 text-center">'+data.security_name+'</td>';
					k+='<td class="col-md-1 text-center">'+data.attendance+'</td>';
		...
		var table_name="tbl_6_4",security_name="",location_name="",attendance="",series_date="";
		...
		function get_input(){
			security_name = $('#securityName').val();
			location_name = $('#Location').val();
			attendance = $('#Attendance').val();
			series_date = $('#seriesDate').val();
			
			if(security_name!=''&&location_name!=''&&attendance!=''){
